...
plantation locations around Labis, Johor. Bilingual interface
...
| Jementah | 利民达 | 2.433331, 102.683331 |
| Tenang Hot Spring | 丁能 热水池 | 2.481236, 103.058050 |
...
```
wnext-weathernextforjohor-202606020001
```
...
- **Storage namespace:** `weathernextforjohor__*` keys in `localStorage`,
