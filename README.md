...
locations around Labis and Segamat, Johor. Multilingual interface
...
This release migrates Johor from the older forecast-only build onto
...
```
https://stanleywoosweeleong.github.io/weathernextforjohor/
```
...
|---|---|---|---|
| Labis - Austin | 拉美士 - Austin | 2.42806, 103.03639 | open plain |
| Segamat Buloh Kasap | 昔加末 巫罗加什 | 2.527677, 102.772178 | open plain |
| Chaah Baru | 三合港 | 2.148561, 103.052319 | open plain |
...
```
wnext-weathernextforjohor-202606062217
```
...
- **Storage namespace:** `weathernextforjohor__*` keys in `localStorage`, isolated
  from other WeatherNext regional builds so data never collides.
- **Cloud sync:** Firebase, namespaced under `appId: wnext-ag-v41-weathernextforjohor`.
