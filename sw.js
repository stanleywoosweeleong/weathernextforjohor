// ============================================================
// WeatherNext Service Worker — Johor (Labis / Segamat)
...
// jh-arch3 (jh-arch1→jh-arch2 added the 4 south-Johor farms 2026-06-09;
// jh-arch2→jh-arch3 corrected Batu Pahat's seeded coords from 2.018361,
// 102.878711 to 1.762222, 102.987500 — safety-gated against user-moved
// farms). bump CACHE_VERSION on each release
// ------------------------------------------------------------
...
// with the refined Raub version. Johor identity is UNCHANGED —
// weathernextforjohor namespace, appId wnext-ag-v41-weathernextforjohor, 6 seed
// farms (Labis/Segamat/Chaah/Bekok/Jementah/Tenang), seed version jh-arch1, and
// the build's GPS sort (N→S, W→E) are all preserved exactly. Only the broadcast
// text logic was swapped (function body verified against the pre-fix baseline,
// zero build-specific drift). Fixes carried over:
...
const CACHE_VERSION = 'wnext-weathernextforjohor-202606172147';
